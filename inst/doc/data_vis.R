## ----setup, include=FALSE-----------------------------------------------------
knitr::opts_chunk$set(echo = TRUE, eval = FALSE, tidy.opts=list(width.cutoff=80), fig.align="center")
...
## ----eval=TRUE, echo=FALSE, out.width = 600-----------------------------------
knitr::include_graphics("../man/figures/interactfig.png")
